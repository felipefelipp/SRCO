...
//            {
//                responsavel = ResponsavelView.CadastrarResponsavel();
//                Paciente.CadastrarPaciente(new Paciente(responsavel, nome, idade, cpf, rg, celular, telefone, rua, numero, bairro, municipio, uf, cep, sexo, profissao, email));

//            } else 
//            {
//                Paciente.CadastrarPaciente(new Paciente(nome, idade, cpf, rg, celular, telefone, rua, numero, bairro, municipio, uf, cep, sexo, profissao, email));
//            }
...
//            Console.WriteLine($"ResponsavelId: {pacienteAtual.Responsavel.IdResponsavel}");
